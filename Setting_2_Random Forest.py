...
X = df.drop(['domain', 'classification', 'non_alphanumeric_count', 'english_word_count'], axis=1)
y = df['classification']
...
results_df.to_csv('evaluation_results_Setting2_randomforest.csv', index=False)
